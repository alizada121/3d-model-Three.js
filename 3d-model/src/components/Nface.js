...
source: https://sketchfab.com/3d-models/face-f6ebbdc7db174be6afd9e2f8e980a2e6
title: Face
*/
...
export default function Model({ ...props }) {
  const group = useRef()
  const { nodes, materials } = useGLTF('/nface.gltf')
  return (
    <group ref={group} {...props} dispose={null}>
      <group position={[-297.82, 375.47, -170.82]} rotation={[0.95, 0.19, -1.68]}>
        ...
        <mesh geometry={nodes.Object_56.geometry} material={materials.material_0} />
